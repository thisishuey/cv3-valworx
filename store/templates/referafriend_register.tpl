...
<h1>Refer-a-Friend Application</h1>

<div class="nopad mar_btm">
  <p>Please remember the email address and password you enter, as that information will be required to login as a Refer-a-Friend affiliate to view the sales and commissions generated by all of your friends.</p>
...
<form method="post" action="index.php"role="form"> 
  <input type="hidden" name="action" value="ReferafriendRegister">
  <div class="row">
    <div class="col-sm-6">
