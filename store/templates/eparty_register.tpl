...
<h1>E-Party Application</h1>

<div class="mar_btm">
  <div class="mar_btm">Please remember the email address and password you enter, as that information will be required to login as an E-Party affiliate to view the sales and commissions generated by your E-Party.</div>

  <div><span class="req">*</span> Indicates a required field.</div>
</div>

{if $valid.return == "1"}
<div class="normaltext"><b>There has been an error. Please double check any fields that show an '<span class="glyphicon glyphicon-remove"></span>'
  <div class="alert alert-danger">{$error}</div>
</div>
{/if}

<form method="post" action="index.php" role="form"> 
  <input type="hidden" name="action" value="EpartyRegister">
  <div>
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group {if $valid.return and  $valid.name == ''}has-error has-feedback bg-danger{/if}">
          <label><span cass="req">*</span> Full Name:</label>
      ...
      <div class="col-sm-6">
       ...
       {if $captcha_method == '1'}
       <div><img src="/get_captcha_image"/></div>
       {/if}
     </div>
     {/if}
   </div>
   <div>
    <input type="submit" name="submit" value="Apply" class="addtocart_btn btn btn-primary mar_btm">
  </div>
</div>
</form>
