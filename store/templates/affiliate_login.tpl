...
<form method="post" action="index.php" name="checkout" role="form"> 
  <input type="hidden" name="action" value="AffiliateLogin" />
    <div>
      <div class="mar_btm">
        <a href="/affiliate_register">Affiliate Application</a>
      </div>
      <fieldset>
      ...
      <div class="mar_btm">
          <a href="/affiliate_forgot">Forgot your password?</a>
      </div>
      </fieldset>
      <div class="mar_btm">
