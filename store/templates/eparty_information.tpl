...
<h1>Edit E-Party Information</h1>
<div class="mar_btm"><a href="eparty">E-Party Report</a>&nbsp;|&nbsp;<a href="eparty_plan">Plan New E-Party</a>&nbsp;|&nbsp;<a href="eparty_create_gc">Create Gift Certificate</a>&nbsp;|&nbsp;<a href="eparty_history">Track Gift Certificates</a>&nbsp;|&nbsp;<a href="eparty_login/1">Log Out</a></div>

<form method="post" action="index.php" role="form"> 
  <input type="hidden" name="action" value="EpartyInformation">
  <div>
    <div class="mar_btm">
