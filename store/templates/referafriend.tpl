...
<h1>Refer-a-Friend - {$affiliate.name}</h1>
<div class="mar_btm">
  <a href="referafriend_create_gc">Create Gift Certificate</a>&nbsp;|&nbsp;<a href="referafriend_history">Track Gift Certificates</a>&nbsp;|&nbsp;<a href="referafriend_information">Edit Account Information</a>&nbsp;|&nbsp;<a href="referafriend_login/1">Log Out</a>
</div>

{if $expired == 'y'}<div class="mar_btm"><b>*Your account has expired.</b></div>{/if}
...
<div class=""><b>Total Commission Due:</b>&nbsp;{$currency_type}{$commission_due}</div>
</div>
